...
export function Cards(props) {
    ...
    return (
        <>
            <React.Fragment key={props.dataElem.id}>
                <div className={styles.home}>
                    <h3 >{props.dataElem.title}</h3>
                    <img src={
                        props.dataElem.poster_path === null ? 'https://media.istockphoto.com/photos/bowl-of-popcorn-in-front-of-a-cinema-projector-picture-id182790916?k=6&m=182790916&s=170667a&w=0&h=0L_xlkRTQnNG0Ks0QiovYlk9YkScyDEn-YRRlcNFCS4=' :
